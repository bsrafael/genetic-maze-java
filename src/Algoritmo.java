...
public class Algoritmo {
  ...
  private static Boolean usePredefinedSolution;
  ...
  public static Boolean getUsePredefinedSolution() {
    return usePredefinedSolution;
  }

  public static void setUsePredefinedSolution(Boolean should) {
    Algoritmo.usePredefinedSolution = should;
  }
}